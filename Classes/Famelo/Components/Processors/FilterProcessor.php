...
class FilterProcessor extends AbstractProcessor {
	...
	public function process($query) {
		...
		$this->viewHelperVariableContainer->add('Famelo\Common\Processor\FilterProcessor', 'filter', $filter);
		$content = $this->viewHelperVariableContainer->getView()->renderPartial('Filter', NULL, array(
			'filter' => $filter,
			'fields' => $fields
		));
		$this->viewHelperVariableContainer->remove('Famelo\Common\Processor\FilterProcessor', 'filter');
